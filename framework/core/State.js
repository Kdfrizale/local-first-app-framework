 ...
 * Provides observable state with automatic UI updates via subscriptions
 * 
 * @example
 * const state = new State({ count: 0, items: [] });
 * 
 ...
 * 
 * // Computed properties
 * state.computed('totalItems', (s) => s.items.length);
 * console.log(state.get('totalItems')); // auto-computed
 */
